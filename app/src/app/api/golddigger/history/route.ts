 ...
 *
 * GET /api/golddigger/history          — Recent conversations
 * GET /api/golddigger/history?type=investments — Recent investment decisions
 * GET /api/golddigger/history?type=research    — Recent research findings
 * GET /api/golddigger/history?q=query          — Search conversations
 * GET /api/golddigger/history?type=stats       — Memory statistics
 */
...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    console.error("[Gold Digger History] Error:", err);
    return NextResponse.json(
