...
export function generateTags(query: string, response: string): string[] {
  ...
  // Extract ticker symbols (uppercase 2-5 chars, filtered against common English words)
  const NOISE_WORDS = new Set([
    // Common English words that are all-caps in formatted text
    "I", "A", "AN", "AS", "AT", "BE", "BY", "DO", "GO", "IF", "IN", "IS", "IT", "MY", "NO",
    "OF", "OK", "ON", "OR", "SO", "TO", "UP", "US", "WE", "AM", "ARE", "BUT", "CAN", "DID",
    "FOR", "GET", "GOT", "HAD", "HAS", "HER", "HIM", "HIS", "HOW", "ITS", "LET", "MAY",
    "NEW", "NOT", "NOW", "OUR", "OUT", "OWN", "RAN", "RUN", "SAY", "SHE", "THE", "TOO",
    "TRY", "USE", "WAY", "WHO", "WHY", "YOU",
    // Common words that appear in investment analysis formatting
    "ALL", "AND", "ANY", "BIG", "DAY", "END", "FEW", "GOT", "HIT", "KEY", "LOW", "MAN",
    "OLD", "ONE", "PUT", "SET", "TOP", "TWO", "WIN", "WON", "YES",
    "ALSO", "BACK", "BEEN", "BEST", "BOTH", "CALL", "CAME", "CASE", "COME", "DONE", "DOWN",
    "EACH", "EVEN", "FIND", "FOUR", "FROM", "FULL", "GAVE", "GOOD", "HALF", "HAVE", "HEAD",
    "HERE", "HIGH", "HOME", "JUST", "KEEP", "KNOW", "LAST", "LEFT", "LESS", "LIKE", "LINE",
    "LIST", "LONG", "LOOK", "MADE", "MAIN", "MAKE", "MANY", "MEAN", "MORE", "MOST", "MUCH",
    "MUST", "NAME", "NEAR", "NEED", "NEXT", "ONLY", "OPEN", "OVER", "PART", "PAST", "PLAY",
    "REAL", "SAID", "SAME", "SHOW", "SIDE", "SOME", "SUCH", "SURE", "TAKE", "TELL", "THAN",
    "THAT", "THEM", "THEN", "THEY", "THIS", "TIME", "TURN", "VERY", "WANT", "WELL", "WENT",
    "WERE", "WHAT", "WHEN", "WILL", "WITH", "WORD", "WORK", "YEAR", "YOUR",
    "ABOVE", "AFTER", "AGAIN", "BEING", "BELOW", "BLIND", "CHECK", "COULD", "DON", "EVERY",
    "FIRST", "FOUND", "GOING", "GREAT", "GROUP", "MIGHT", "MONEY", "NEVER", "OTHER", "POINT",
    "PRICE", "RIGHT", "SETUP", "SHALL", "SINCE", "SMALL", "SPOTS", "STAGE", "START", "STATE",
    "STILL", "THEIR", "THERE", "THESE", "THINK", "THREE", "TODAY", "TRADE", "UNDER", "UNTIL",
    "WHERE", "WHICH", "WHILE", "WHOSE", "WORLD", "WOULD",
    // Common headers / formatting words in Gold Digger responses
    "RADAR", "ITEM", "CHASE", "FOMO", "ALERT", "NOTE", "NOTES", "ENTRY", "STOP", "LOSS",
    "RISK", "GAIN", "GAINS", "MOVE", "MOVED", "MOVES", "ZONE", "RANGE", "BREAK", "LEVEL",
    "TREND", "SHIFT", "SCORE", "TOTAL", "ABOUT",
    "SIGNAL", "ACTION", "ACTIVE", "WEALTH", "REVIEW", "URGENT", "UPDATE",
  ]);
  ...
  while ((match = tickerRegex.exec(query + response)) !== null) {
    ...
    // Must be 2-5 chars (single letter is almost always noise)
    // Must not be in noise words list
    if (candidate.length >= 2 && candidate.length <= 5 && !NOISE_WORDS.has(candidate)) {
      tags.add(candidate);
    }
  }
