 ...
 * Evolved from Gold Digger AGI wealth intelligence agent.
 *
...
export const GOLDDIGGER_CORE_IDENTITY = `You are "Gold Digger AGI" — a proactive investment and opportunity intelligence system.
...
export function getAgentPrompt(agentType: AgentType): string {
  ...
  const parts = [GOLDDIGGER_CORE_IDENTITY, agentPrompt];
  if (profileContext) {
